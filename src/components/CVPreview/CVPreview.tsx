...
export const CVPreview: React.FC = () => {
  const { cvData, activePreset, activeLanguage, selectedTags } = useCV();
      ...
      <div className="bg-slate-900 border border-slate-800 rounded-2xl p-4 shadow-lg flex flex-wrap items-center justify-between gap-4">
        ...
        <div className="flex items-center gap-2">
          <span className="text-xs font-semibold text-slate-300 flex items-center gap-1.5">
            ...
            <span>ATS Classic Format (Single Page Standard)</span>
          </span>
        </div>
        ...
        <div className="flex items-center gap-3">
          ...
          <button
            ...
            className="flex items-center gap-2 bg-gradient-to-r from-sky-500 to-blue-600 hover:from-sky-400 hover:to-blue-500 text-white px-4 py-2 rounded-xl text-xs font-bold shadow-md shadow-sky-500/20 disabled:opacity-50 transition-all cursor-pointer"
          >
