...
export const ModernTemplate: React.FC<TemplateProps> = ({ data, language, selectedTags, preset }) => {
  ...
  return (
    <div className="w-full max-w-[210mm] min-h-[297mm] bg-white text-slate-800 p-8 font-sans shadow-2xl mx-auto box-border text-[11px] leading-relaxed overflow-hidden">
