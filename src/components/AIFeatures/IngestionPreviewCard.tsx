...
export const IngestionPreviewCard: React.FC<{
  ...
  return (
    <div className="bg-slate-950 border border-sky-800/40 rounded-xl p-4 space-y-3.5 text-xs text-slate-200">
      ...
      <div className="bg-slate-900/90 border border-slate-800 rounded-lg p-3 space-y-2">
        <div className="flex justify-between items-start">
          <div>
            ...
            {preview.detectedBio && (
              <p className="text-[11px] text-slate-400 mt-1 line-clamp-2 leading-relaxed">{preview.detectedBio}</p>
            )}
          </div>
        </div>
      ...
      {preview.experiences.length > 0 && (
        <div className="space-y-1.5">
          <span className="text-[11px] font-semibold text-slate-400 flex items-center gap-1">
            ...
            <span>Work Experience ({preview.experiences.length}):</span>
          </span>
          <div className="space-y-1 max-h-36 overflow-y-auto pr-1">
            {preview.experiences.map((exp, idx) => (
      ...
      {preview.projects.length > 0 && (
        <div className="space-y-1">
          <span className="text-[11px] font-semibold text-slate-400 flex items-center gap-1">
            ...
            <span>Projects ({preview.projects.length}):</span>
          </span>
          <div className="space-y-1">
