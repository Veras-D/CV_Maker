...
export interface ArchivedColumnProps {
  title: string;
  roles: KanbanRole[];
  draggedCardId: string | null;
  dragOverColumn: string | null;
  onDragOver: (e: React.DragEvent, colId: 'archived') => void;
  onDragLeave: (e: React.DragEvent) => void;
  onDrop: (e: React.DragEvent, colId: 'archived') => void;
...
export const ArchivedColumn: React.FC<ArchivedColumnProps> = ({
  ...
  const isDropTarget = dragOverColumn === 'archived' && draggedCardId !== null;
